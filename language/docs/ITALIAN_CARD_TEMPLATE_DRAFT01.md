# Italian card template

## Front
```html
<div class="concept-id">{{ID}}</div>
<div class="layer-name">Italiano</div>
<div class="target-word">{{Italian}}</div>
{{#Pronunciation}}<div class="pronunciation">/{{Pronunciation}}/</div>{{/Pronunciation}}
<div class="tts-audio">{{tts it_IT:Italian}}</div>
```
...
{{#ExampleItalian}}<div class="section example-section"><div class="label">例文・Italiano</div><div class="example-text">{{ExampleItalian}}</div></div><div class="tts-audio">{{tts it_IT:ExampleItalian}}</div>{{/ExampleItalian}}
