# Spanish card template

## Front
```html
<div class="concept-id">{{ID}}</div>
<div class="layer-name">Español</div>
<div class="target-word">{{Spanish}}</div>
{{#Pronunciation}}<div class="pronunciation">/{{Pronunciation}}/</div>{{/Pronunciation}}
<div class="tts-audio">{{tts es_ES:Spanish}}</div>
```
...
{{#ExampleSpanish}}<div class="section example-section"><div class="label">例文・Español</div><div class="example-text">{{ExampleSpanish}}</div></div><div class="tts-audio">{{tts es_ES:ExampleSpanish}}</div>{{/ExampleSpanish}}
