# Brazilian Portuguese card template

## Front
```html
<div class="concept-id">{{ID}}</div>
<div class="layer-name">Português do Brasil</div>
<div class="target-word">{{Portuguese}}</div>
{{#Pronunciation}}<div class="pronunciation">/{{Pronunciation}}/</div>{{/Pronunciation}}
<div class="tts-audio">{{tts pt_BR:Portuguese}}</div>
```
...
{{#UsageNote}}<div class="section"><div class="label">意味と用法</div><div class="content">{{UsageNote}}</div></div>{{/UsageNote}}
{{#ExamplePortuguese}}<div class="section example-section"><div class="label">例文・Português</div><div class="example-text">{{ExamplePortuguese}}</div></div><div class="tts-audio">{{tts pt_BR:ExamplePortuguese}}</div>{{/ExamplePortuguese}}
...
{{#Root}}<div class="section root-section"><div class="label">語幹</div><div class="root-form">{{Root}}</div></div>{{/Root}}
{{#Affixes}}<div class="section affix-section"><div class="label">接辞・語尾</div><div class="content">{{Affixes}}</div></div>{{/Affixes}}
{{#PerceptualSegmentation}}<div class="section segmentation"><div class="label">音節と強勢</div><div class="segment-form">{{PerceptualSegmentation}}</div></div>{{/PerceptualSegmentation}}
...
{{#SoundBridge}}<div class="section sound"><div class="label">音と強勢の橋</div><div class="content">{{SoundBridge}}</div></div>{{/SoundBridge}}
