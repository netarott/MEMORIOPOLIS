# Vietnamese card template

## Front
```html
<div class="concept-id">{{ID}}</div>
<div class="layer-name">Tiếng Việt</div>
<div class="target-word">{{Vietnamese}}</div>
{{#Pronunciation}}<div class="pronunciation">{{Pronunciation}}</div>{{/Pronunciation}}
<div class="tts-audio">{{tts vi_VN:Vietnamese}}</div>
```
...
{{#ExampleVietnamese}}<div class="section example-section"><div class="label">例文・Tiếng Việt</div><div class="example-text">{{ExampleVietnamese}}</div></div><div class="tts-audio">{{tts vi_VN:ExampleVietnamese}}</div>{{/ExampleVietnamese}}
...
{{#Root}}<div class="section root-section"><div class="label">語構成</div><div class="root-form">{{Root}}</div></div>{{/Root}}
...
{{#SoundBridge}}<div class="section sound"><div class="label">音・声調の橋</div><div class="content">{{SoundBridge}}</div></div>{{/SoundBridge}}
